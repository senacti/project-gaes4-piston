...
class VehiculoController extends Controller
{
    ...
    public function index(Request $request)
     ...
     public function desactivar($id)
     {
         ...
         return redirect()->route('vehiculos.index')->with('success', 'vehiculo desactivada correctamente.');
     }
     ...
     public function activar($id)
     {
         ...
         return redirect()->route('vehiculos.index')->with('success', 'vehiculo activada correctamente.');
     }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vehiculos.index')
            ->with('success', 'El vehiculo se ha registrado de manera exitosa.');
    }
