...
public function desactivar($id)
{
    ...
    return redirect()->route('tarea.index')->with('success', 'tarea desactivada correctamente.');
}
...
public function activar($id)
{
    ...
    return redirect()->route('tarea.index')->with('success', 'tarea activada correctamente.');
}
