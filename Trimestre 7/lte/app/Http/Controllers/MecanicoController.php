    ...
    public function desactivar($id)
     {
         ...
         return redirect()->route('mecanicos.index')->with('success', 'vehiculo desactivada correctamente.');
     }
     ...
     public function activar($id)
     {
         ...
         return redirect()->route('mecanicos.index')->with('success', 'vehiculo activada correctamente.');
     }
