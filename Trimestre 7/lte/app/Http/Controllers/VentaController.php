...
public function desactivar($id)
{
    ...
    return redirect()->route('venta.index')->with('success', 'Venta desactivada correctamente.');
}
...
public function activar($id)
{
    ...
    return redirect()->route('venta.index')->with('success', 'Venta activada correctamente.');
}
