    ...
    public function desactivar($id)
{
    ...
    return redirect()->route('clientes.index')->with('success', 'cliente desactivada correctamente.');
}
...
public function activar($id)
{
    ...
    return redirect()->route('clientes.index')->with('success', 'cliente activada correctamente.');
}
