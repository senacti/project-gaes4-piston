    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="float-right">
                        ...
                        <div class="text-right"> <!-- Alineación a la derecha -->
                            ...
                            <a href="{{ route('venta.index') }}" class="btn btn-primary btn-sm" data-placement="right">
                                 {{ __('Volver a ventas habilitadas') }}
                             </a>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example" class="table table-striped nowrap"style="width: 100%">
                                ...
                                <tbody>
                                    @foreach ($ventasDesactivadas as $venta)
                                        <tr>
                                            <td>{{ $venta->id }}</td>
             ...
             @if($venta->desactivado)
                <form action="{{ route('ventas.activar', $venta->id) }}" method="POST">                               
