...
<div class="main-error-page">
    ...
    <h1 class="error-title">
      Upps! <br>Parece que te perdiste :(
    </h1>
    <h2 class="error-subtitle">
     Me parace que tienes que devolverte
     <br>
     <br>
     <a href="/clientes">
        <button class="btn btn-warning" style="font-size: 20px; font-weight: bold;">VOLVER AL DASHBOARD</button>
    </h2>
</a>
