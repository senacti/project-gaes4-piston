...
<div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input id="direccion" name="direccion" type="text" class="form-control" required oninvalid="this.setCustomValidity('Por favor ingresa un valor valido, recuerda que no puede tener numeros o caracteres especiales.')"
  ...
  <a href="/mecanico" class="btn btn-secondary">Cancelar</a>
