...
$mensaje=[ 'required'=>'Su :attribute es requerido '];
  ...
  return  redirect('mecanico')->with('mensaje','¡Mecanico agregado con exito!');
    ...
    $mensaje=[ 'required'=>'Su :attribute es requerido '];
      ...
      $this->validate($request,$campos,$mensaje);
        ...
        $mecanico=Mecanico::findOrFail($id);
        /*return view('mecanico.edit',compact('mecanico'));*/
        return redirect('mecanico')->with('Mensaje', 'Dato actualizado con éxito');
    ...
    public function destroy( $id)
    {
        ...
        $mecanico->save();
        return redirect()->route('mecanico.index')->with('mensaje', 'Mecanico inhabilitado con éxito');
