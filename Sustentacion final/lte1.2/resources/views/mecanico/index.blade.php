                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="float-right">
                                ...
                                <form action="{{ route('mecanicos.index') }}" method="get">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="cedula" class="form-control"
                                            placeholder="Cedula del empleado" value="{{ request('cedula') }}">

                                        <label for="especialidad"class="ml-2 mr-2">Especialidad del mecanico:</label>
                                        <input type="text" name="especialidad" class="form-control"
                                            placeholder="Especialidad mecanico" value="{{ request('especialidad') }}">
                                ...
                                <div class="text-right"> <!-- Alineación a la derecha -->
                                    ...
                                    <a href="{{ route('mecanicos.desactivadas') }}" class="btn btn-primary btn-sm"
                                        data-placement="right">
                                        {{ __('Mecanicos Desabilitados') }}
                                    </a>

                                    <a href="{{ route('mecanicos.pdf') }}" class="btn btn-warning btn-sm "
                                        data-placement="left">
                                        {{ __('Reporte PDF') }}

                                    </a>

                                    <a href="{{ route('mecanicos.export') }}" class="btn btn-success btn-sm "
                                        data-placement="left">
                                        {{ __('Reporte EXCEL') }}

                                    </a>

                                    <a href="{{ route('mecanicos.create') }}" class="btn btn-primary btn-sm "
                                        data-placement="left">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form class="formulario-eliminar"
                                                        action="{{ route('mecanicos.desactivar', $mecanico->id) }}"
                                                        method="POST">
    ...
    @section('js')
        ...
        @if (session('editar') == 'ok')
            <script>
                Swal.fire(
                    '¡Actualizado!',
                    'El empleado se ha editado exitosamente',
                    'success'
        ...
        @if (session('agregar') == 'ok')
            <script>
                Swal.fire(
                    '¡Agregado!',
                    'El empleado se ha creado exitosamente',
                    'success'
