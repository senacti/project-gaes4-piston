...
@section('title', 'PISTON | Dashboard')
...
@section('content_header')
    <h1>Bienvenido a PISTON</h1>
@stop

@section('content')
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Bienvenido a PISTON </h5>
            </div>
            <div class="card-body">

                <p class="card-text">Aqui encontraras realizaras todas las operaciones escenciales de la compañia.</p>
            </div>
        </div>
