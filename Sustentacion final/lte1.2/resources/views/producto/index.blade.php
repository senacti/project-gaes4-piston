                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="float-right">
                                ...
                                <form action="{{ route('productos.index') }}" method="get">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="nombre_producto" class="form-control"
                                            placeholder="Nombre del Producto" value="{{ request('nombre_producto') }}">
                                ...
                                <div class="text-right"> <!-- Alineación a la derecha -->
                                    ...
                                    <a href="{{ route('productos.desactivadas') }}" class="btn btn-primary btn-sm"
                                        data-placement="right">
                                        {{ __('Productos Desabilitados') }}
                                    </a>

                                    <a href="{{ route('productos.pdf') }}" class="btn btn-warning btn-sm "
                                        data-placement="left">
                                        {{ __('Reporte PDF') }}
                                    </a>

                                    <a href="{{ route('productos.export') }}" class="btn btn-success btn-sm "
                                        data-placement="left">
                                        {{ __('Reporte EXCEL') }}
                                    </a>
