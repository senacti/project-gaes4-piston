                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="float-right">
                                ...
                                <form action="{{ route('servicios.index') }}" method="get">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="nombre_servicio" class="form-control"
                                            placeholder="Nombre del servicio" value="{{ request('nombre_servicio') }}">
                                ...
                                <div class="text-right"> <!-- Alineación a la derecha -->
                                    ...
                                    <a href="{{ route('servicios.desactivadas') }}" class="btn btn-primary btn-sm"
                                        data-placement="right">
                                        {{ __('Servicios Desabilitados') }}
                                    </a>

                                    <a href="{{ route('servicios.pdf') }}" class="btn btn-warning btn-sm "
                                        data-placement="left">
                                        {{ __('Reportes PDF') }}
                                    </a>

                                    <a href="{{ route('servicios.export') }}" class="btn btn-success btn-sm "
                                        data-placement="left">
                                        {{ __('Reportes EXCEL') }}
                                    </a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form class="formulario-eliminar"
                                                        action="{{ route('servicios.desactivar', $servicio->id) }}"
                                                        method="POST">
    ...
    @section('js')
        ...
        @if (session('editar') == 'ok')
            <script>
                Swal.fire(
                    '¡Actualizado!',
                    'El servicio se ha editado exitosamente',
                    'success'
